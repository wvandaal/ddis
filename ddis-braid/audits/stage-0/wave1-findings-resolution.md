...
| S13 | MAJOR | LIVE index implementation guidance absent | LIVE index guidance added to guide/01-store.md | Session 008 (brai-39v.13) |
...
| S17 | MINOR | Redb tables described as persistent store (vs derived caches per C3) | Documented as derived caches in guide/00-architecture.md | Session 008 (brai-1cp.11) |
| S18 | MINOR | Cross-namespace types missing from architecture catalog | ~30 cross-namespace types added to guide/00-architecture.md §0.4 | Session 008 (brai-1cp.11) |
...
| S36 | MINOR | Stage 0 count discrepancy in guide/11-worked-examples.md | Fixed: "52" corrected to match actual count | Session 008 (brai-3gn.3) |
| S37 | MINOR | Percentage error in guide/10-verification.md | Fixed: 14.0% corrected to 12.4% | Session 008 (brai-3gn.4) |
...
| Q3 | MAJOR | QueryResult missing mode and provenance_tx fields | Fields added to guide/03-query.md | Session 008 (brai-1cp.4) |
...
| Q11 | MINOR | Graph algorithm INVs have no three-box decomposition in guide | Graph engine build plan added to guide/03-query.md | Session 007 |
...
| RM12 | MINOR | Missing proptest for INV-RESOLUTION-003 | Proptest added to guide/04-resolution.md | Session 008 |
| RM13 | MINOR | Missing proptest for INV-RESOLUTION-007 | Proptest added to guide/04-resolution.md | Session 008 |
...
| HS13 | MINOR | Missing proptest for INV-HARVEST-007 | Proptest added to guide/05-harvest.md | Session 008 |
| HS14 | MINOR | Missing proptest for INV-SEED-004 | Proptest added to guide/06-seed.md | Session 008 |
...
| G4 | MAJOR | guide/08-guidance.md contradicts ADR-GUIDANCE-001 (flat rules vs comonadic topology) | Guidance types fully reconciled to match spec | R1.11 (brai-30q.11) |
...
| G9 | MINOR | Agent-mode display-to-semantic mapping missing | Added to guide/09-interface.md | Session 008 |
| G10 | MINOR | 10 default guidance derivation rules undocumented | All 10 rules documented in guide/08-guidance.md | Session 008 (brai-39v.5) |
...
| IB9 | MINOR | Missing proptest for INV-INTERFACE-002 | Proptest added to guide/09-interface.md | Session 008 |
...
| IB19 | MAJOR | Guide/architecture type catalog missing graph engine types | Graph types added to guide/00-architecture.md | Session 007 |
...
| AV11 | MAJOR | All 38 Kani harnesses not enumerated | All 38 enumerated in guide/10-verification.md | Session 008 (brai-39v.6) |
