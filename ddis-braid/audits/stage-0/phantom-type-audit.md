...
> **Date**: 2026-03-03
> **Method**: Systematic cross-reference of guide/00-architecture.md Type Catalog (section 0.2),
> all guide/ implementation plans (01-store through 09-interface, 10-12), and all spec/
...
These types appear in the guide/00-architecture.md section 0.2 Type Catalog but have no
...
| **Namespace** | STORE |
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Cross-Namespace Types) |
| **Guide location** | guide/00-architecture.md lines 409-413, guide/01-store.md (Transaction::receipt) |
...
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Cross-Namespace Types) |
| **Guide location** | guide/00-architecture.md lines 415-419, guide/01-store.md, guide/02-schema.md |
...
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Cross-Namespace Types) |
| **Guide location** | guide/00-architecture.md line 423, guide/02-schema.md (SchemaValidationError) |
...
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Cross-Namespace Types) |
| **Guide location** | guide/00-architecture.md line 432 |
...
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Cross-Namespace Types) |
| **Guide location** | guide/00-architecture.md line 433, guide/03-query.md |
...
| **Namespace** | QUERY |
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Cross-Namespace Types, line 435) |
| **Guide location** | guide/00-architecture.md line 435 |
...
| **Namespace** | QUERY |
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md section 0.2 (Graph Engine Types, lines 356-360) |
| **Guide location** | guide/00-architecture.md lines 356-360, guide/03-query.md |
...
| **Guide location** | guide/01-store.md (Transaction::apply return type) |
...
| **Guide location** | guide/01-store.md (Store::frontier field), guide/00-architecture.md |
...
| **Namespace** | STORE |
| **Stage** | 0 |
| **Type Catalog location** | Referenced in Store struct (guide/00-architecture.md line 293) |
| **Guide location** | guide/01-store.md (Store fields) |
...
| **Guide location** | guide/01-store.md |
...
| **Namespace** | HARVEST |
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md line 450 (HarvestResult contains drift_score + quality) |
| **Guide location** | guide/05-harvest.md lines 68-73 |
...
| **Guide location** | guide/05-harvest.md lines 89-94 |
...
| **Guide location** | guide/05-harvest.md lines 50-54 |
...
| **Namespace** | HARVEST |
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md line 451 |
| **Guide location** | guide/05-harvest.md lines 36-41 |
...
| **Namespace** | SEED |
| **Stage** | 0 |
| **Type Catalog location** | guide/00-architecture.md line 455 |
| **Guide location** | guide/00-architecture.md line 455, guide/06-seed.md (uses SeedOutput as the agent-facing formatted template) |
...
| **Guide location** | Not directly in guide/ build plans |
...
| **Guide location** | Not in guide/ build plans |
...
## Section 2: Guide-Only Types (in guide/ but not in spec/)

These types are defined in guide/ implementation plans (guide/01-store through guide/09-interface)
...
### 2.1 SchemaLayer (guide/02-schema.md)

| Field | Value |
|-------|-------|
| **Namespace** | SCHEMA |
| **Stage** | 0 |
| **Guide location** | guide/02-schema.md (enum: Layer0_Axiomatic through Layer5_Extension) |
...
### 2.2 LayerViolation (guide/02-schema.md)

| Field | Value |
|-------|-------|
| **Namespace** | SCHEMA |
| **Stage** | 0 |
| **Guide location** | guide/02-schema.md (error type for layer validation) |
| **Spec location** | None. |
...
### 2.3 LatticeDefError (guide/02-schema.md)

| Field | Value |
|-------|-------|
| **Namespace** | SCHEMA |
| **Stage** | 0 |
| **Guide location** | guide/02-schema.md |
| **Spec location** | None. |
...
### 2.4 SchemaValidationError (guide/02-schema.md)
...
### 2.5 Stratum (guide/03-query.md)

| Field | Value |
|-------|-------|
| **Namespace** | QUERY |
| **Stage** | 0 |
| **Guide location** | guide/03-query.md (enum: S0_Primitive, S1_MonotonicJoin, ..., S5_Temporal) |
...
### 2.6 FindSpec (guide/03-query.md)

| Field | Value |
|-------|-------|
| **Namespace** | QUERY |
| **Stage** | 0 |
| **Guide location** | guide/03-query.md |
...
### 2.7 ParsedQuery (guide/03-query.md)
...
### 2.8 ParseError / QueryError (guide/03-query.md)
...
### 2.9 DirectedGraph (guide/03-query.md)
...
### 2.10 PullPattern / EntityRef (guide/03-query.md)
...
### 2.11 CascadeReceipt (guide/07-merge-basic.md)

| Field | Value |
|-------|-------|
| **Namespace** | MERGE |
| **Stage** | 0 |
| **Guide location** | guide/07-merge-basic.md lines 103-110 |
...
### 2.12 DriftSignals (guide/08-guidance.md)

| Field | Value |
|-------|-------|
| **Namespace** | GUIDANCE |
| **Stage** | 0 |
| **Guide location** | guide/08-guidance.md lines 84-92 |
...
### 2.13 GuidanceMechanism (guide/08-guidance.md)

| Field | Value |
|-------|-------|
| **Namespace** | GUIDANCE |
| **Stage** | 0 |
| **Guide location** | guide/08-guidance.md |
| **Spec location** | None. |
...
### 2.14 DriftPriority (guide/08-guidance.md)
...
### 2.15 GuidanceOutput (guide/08-guidance.md)

| Field | Value |
|-------|-------|
| **Namespace** | GUIDANCE |
| **Stage** | 0 |
| **Guide location** | guide/08-guidance.md lines 94-102 |
...
### 2.16 ValueTemplate / PriorityFn (guide/08-guidance.md)

| Field | Value |
|-------|-------|
| **Namespace** | GUIDANCE |
| **Stage** | 0 |
| **Guide location** | guide/08-guidance.md lines 141-142, line 135 |
...
### 2.17 ClaudeMdConfig / AmbientSection / ActiveSection / Demonstration / DriftCorrection (guide/08-guidance.md)

| Field | Value |
|-------|-------|
| **Namespace** | GUIDANCE |
| **Stage** | 0 |
| **Guide location** | guide/08-guidance.md (CLAUDE.md generation pipeline types) |
...
### 2.18 CommandRecord / SessionState (guide/08-guidance.md)

| Field | Value |
|-------|-------|
| **Namespace** | GUIDANCE / INTERFACE |
| **Stage** | 0 |
| **Guide location** | guide/08-guidance.md (detect_drift parameter), guide/09-interface.md |
...
### 2.19 MCPServer (guide/09-interface.md)

| Field | Value |
|-------|-------|
| **Namespace** | INTERFACE |
| **Stage** | 0 |
| **Guide location** | guide/09-interface.md lines 105-126 |
...
### 2.20 ToolDescription / TypedParam (guide/09-interface.md)

| Field | Value |
|-------|-------|
| **Namespace** | INTERFACE |
| **Stage** | 0 |
| **Guide location** | guide/09-interface.md lines 136-142 |
...
### 2.21 RecoveryHint / RecoveryAction / KernelError (guide/09-interface.md)

| Field | Value |
|-------|-------|
| **Namespace** | INTERFACE |
| **Stage** | 0 |
| **Guide location** | guide/09-interface.md lines 202-218 |
...
### 2.22 PersistenceError (guide/09-interface.md)

| Field | Value |
|-------|-------|
| **Namespace** | INTERFACE |
| **Stage** | 0 |
| **Guide location** | guide/09-interface.md (load_store/save_store return type) |
| **Spec location** | None. |
| **Recommendation** | **Keep guide-only.** PersistenceError is a binary-crate concern (IO boundary), not a kernel invariant. The spec explicitly excludes IO from the kernel (guide/00-architecture.md: braid-kernel has no IO). |

### 2.23 SeedOutput (guide/06-seed.md)

| Field | Value |
|-------|-------|
| **Namespace** | SEED |
| **Stage** | 0 |
| **Guide location** | guide/06-seed.md lines 31-37 |
...
These types are defined in spec/ Level 2 sections but are not mentioned in any guide/
...
| **Guide location** | None. |
| **Recommendation** | **Correctly omitted.** INV-STORE-013 is Stage 2 (branching). guide/01-store.md correctly defers this. |
...
| **Guide location** | None. guide/07-merge-basic.md explicitly states "Branching (INV-MERGE-003-007) deferred to Stage 2." |
| **Recommendation** | **Correctly omitted.** Stage 2 type. guide/07-merge-basic.md correctly covers only Stage 0 merge (set union). |
...
| **Guide location** | guide/08-guidance.md lines 25-28 |
...
| **Guide location** | guide/08-guidance.md lines 30-36 |
| **Recommendation** | **No action needed.** This IS in the guide. Not a spec-only type. |
...
| **Guide location** | guide/08-guidance.md lines 38-43 |
| **Recommendation** | **No action needed.** This IS in the guide. Not a spec-only type. |
...
| **Guide location** | None. guide/04-resolution.md describes BLAKE3 tie-breaking in prose (line 89) but does not define LwwClock as a type. |
...
| **Guide location** | guide/04-resolution.md uses ConflictSet (similar but different name/structure). |
...
| **Guide location** | guide/04-resolution.md uses RoutingTier (Automatic, AgentNotification, HumanRequired). |
...
| **Guide location** | guide/04-resolution.md uses ResolvedValue (enum: Single, Multi, Conflict). |
...
| **Guide location** | Not defined as a struct. guide/05-harvest.md uses `harvest_session_entity()` function that creates a session entity but does not define the struct. |
...
| **Guide location** | Not defined. guide/05-harvest.md mentions "Stage 0 = single-agent self-review" but does not define the ReviewTopology enum. |
...
| **Guide location** | guide/06-seed.md defines `generate_claude_md()` as a free function (line 43) but not as a struct with methods. |
...
| **Guide location** | guide/09-interface.md uses `const MCP_TOOLS: [&str; 6]` (line 129) as a string array, not an enum. |
...
### Priority 2: Add to guide/ (4 types from Section 3)

These types are defined in spec/ for Stage 0 but are missing from guide/ build plans.

| Type | Target File | Rationale |
|------|-------------|-----------|
| LwwClock | guide/04-resolution.md | Stage 0 type for INV-RESOLUTION-005 |
| Resolution (provenance entity) | guide/04-resolution.md | NEG-RESOLUTION-003 requires resolution provenance |
| HarvestSession | guide/05-harvest.md | INV-HARVEST-002 provenance trail |
| ReviewTopology | guide/05-harvest.md | At minimum SelfReview variant for Stage 0 |
...
|-----------|-----------|------|---------------|
| Conflict | ConflictSet | spec/04-resolution.md, guide/04-resolution.md | Adopt ConflictSet (richer, separates assertions/retractions) |
| ConflictTier | RoutingTier | spec/04-resolution.md, guide/04-resolution.md | Adopt RoutingTier (more descriptive variant names) |
| MCPTool (enum) | MCP_TOOLS (string array) | spec/14-interface.md, guide/09-interface.md | Adopt enum pattern from spec (stronger guarantee) |
