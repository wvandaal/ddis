...
<!-- Updated: 1774359969 | Store: 323 datoms -->
...
<braid-seed>
<!-- Generated by braid. Do not edit manually. Regenerate: braid seed --inject AGENTS.md -->
<!-- Updated: 1774359969 | Store: 323 datoms, 67 entities -->

### Session Context
Braid: append-only datom store with CRDT merge. Harvest/seed lifecycle makes conversations disposable, knowledge durable.
Braid: append-only datom store (CRDT merge, content-addressed). 323 datoms, 67 entities.
Goal: harvest/seed replaces HARVEST.md. Status: 0 harvests, 0 observations, 0 decisions captured.

### Recent Entities
- Project context: Stage 0
Core: datom [e,a,v,tx,op]. Store = grow-only set (CRDT merge = set union). 14 distinct attributes in use.
...
- :policy/claim-pattern — Attribute pattern identifying claim entities (e.g., ':spec/element-type'). Multiple patterns allowed — an entity matching ANY pattern is a claim.
