...
//!
//! This module lives in the CLI crate (not braid-kernel) because it
//! performs filesystem I/O. The kernel crate is pure computation with
//! no IO, no filesystem access (C8 constraint).
...
mod tests {
    ...
    fn test_generate_on_braid_project() {
        // Test against the braid project itself (two levels up from braid CLI crate)
