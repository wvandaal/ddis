...
pub use graph::{
    ...
    kirchhoff_from_partial_spectrum, kirchhoff_from_spectrum, kirchhoff_index,
    ...
    spectral_decomposition, spectral_decomposition_adaptive, structural_complexity, topo_sort,
