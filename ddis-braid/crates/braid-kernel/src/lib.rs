...
pub use guidance::{
    ...
    compute_methodology_score_dampened, compute_routing, compute_routing_from_store,
    compute_routing_with_calibration, contextual_observation_hint, create_session_start_datoms,
    ...
    detect_activity_mode, detect_ineffective_guidance, detect_session_start, detect_stagnation,
    dynamic_threshold, extract_block_labels, find_active_session, format_actions, format_footer,
    format_footer_at_level, generate_bridge_hypotheses, guidance_recommendation_datoms,
    harvest_urgency_multi, harvest_warning_from_k_eff, harvest_warning_level,
    hypothesis_completed_count, hypothesis_count, ineffective_metric_names, is_actionable_decision,
    knowledge_relevance_scan, measure_guidance_effectiveness, methodology_context_blocks,
    ...
    spec_relevance_scan, suggest_task_title, telemetry_from_store, tx_velocity, worst_metric_name,
    ActionCategory, ActivityMode, AdjustedGaps, BridgeHypothesis, CalibrationReport,
    CalibrationTrend, ConcentrationSignal, ContextualHint, DerivationRule, DerivedTask,
    GuidanceAction, GuidanceContext, GuidanceFooter, GuidanceOutcome, HarvestWarningLevel,
    MethodologyComponents, MethodologyGaps, MethodologyScore, ReconciliationResult,
    RoutingDashboard, RoutingMetrics, SessionTelemetry, StagnationSignal, TaskNode, TaskRouting,
