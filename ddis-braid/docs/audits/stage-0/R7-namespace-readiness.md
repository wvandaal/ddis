...
> **Date**: 2026-03-03
> **Scope**: Read-only verification across spec/ and docs/guide/types.md
...
All types referenced in L2 contracts are defined in `docs/guide/types.md`:
...
All types in `docs/guide/types.md`: Schema, AttributeSpec, AttributeDef, ValueType,
...
All types in `docs/guide/types.md`: QueryExpr, ParsedQuery, QueryResult, FindSpec, Clause,
...
All types in `docs/guide/types.md`: ResolutionMode, ConflictSet, RoutingTier, Resolution.
...
All types in `docs/guide/types.md` (or spec section 5.3): HarvestCandidate, HarvestCategory,
...
All types in `docs/guide/types.md` (or spec section 6.3): SchemaNeighborhood, AssembledContext,
...
All types in `docs/guide/types.md` (or spec section 7.3): MergeReceipt, CascadeReceipt,
...
All types in `docs/guide/types.md` (or spec section 12.3): GuidanceTopology, GuidanceNode,
...
All types in `docs/guide/types.md` (or spec section 14.3): OutputMode, MCPServer, MCPPhase,
...
The `docs/guide/types.md` canonical type catalog covers all types referenced in Stage 0 L2
