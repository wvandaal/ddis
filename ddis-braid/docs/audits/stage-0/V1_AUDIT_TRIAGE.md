...
The audit examined every file in `spec/` (17 files) and `docs/guide/` (13 files), plus the foundational documents SEED.md, ADRS.md, GAP_ANALYSIS.md, and FAILURE_MODES.md. It was conducted in two waves:
