...
| **ADRS.md** | `docs/design/ADRS.md` | Design decision index (FD, PD, SQ, LD series) |
...
### Cross-References to docs/HARVEST.md

This exploration should be recorded as a session entry in `docs/HARVEST.md`. The entry should
