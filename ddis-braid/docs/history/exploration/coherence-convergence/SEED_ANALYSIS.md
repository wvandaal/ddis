...
11. [Cross-Reference: Alignment with Implementation Guide (docs/guide/)](#11-cross-reference-guide)
...
| Implementation Guide | `docs/guide/` (13 files) | ~3,600 lines | Build plan |
| ADR Index | `docs/design/ADRS.md` | ~500 lines | Settled design decisions |
...
## 11. Cross-Reference: Alignment with Implementation Guide (docs/guide/)
...
A new guide file (`docs/guide/XX-coherence.md`) is needed alongside `spec/18-coherence.md`.
