...
>
> **Audit scope**: All `.rs` files in `crates/braid-kernel/src/`, `crates/braid/src/`, and
> `crates/braid-kernel/tests/`. 288 tests passing at audit start. Cargo clippy clean.
>
...
**Severity**: HIGH
**Files**: `crates/braid-kernel/src/store.rs:489-527`, `crates/braid/src/commands/log.rs:45-49`
...
**Severity**: MEDIUM
**Files**: `crates/braid/src/layout.rs:133`
...
**Severity**: MEDIUM
**Files**: `crates/braid-kernel/src/trilateral.rs:103-151`
...
**Severity**: LOW
**Files**: `crates/braid-kernel/src/store.rs:356`, `crates/braid-kernel/src/resolution.rs:153-154`
...
**Files**: `crates/braid-kernel/src/trilateral.rs:349-355`
...
**Type**: UX limitation
**Severity**: MEDIUM
**Files**: `crates/braid/src/commands/log.rs:32`
