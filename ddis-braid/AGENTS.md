...
<!-- Updated: 1774532453 | Store: 107575 datoms -->

## Methodology Gaps
- 123 observations with uncrystallized spec IDs → braid spec create
- 29 tasks with unresolved spec refs → crystallize first
- 265 current-stage INVs untested → add L2+ witness
- concentration: 15 traces in STORE — Review: braid task search INV-STORE
...
2. "ATT-3-IMPL: Task-conditioned relevance scoring via spec name" (impact=0.46) → braid go t-88751f73
3. "CE-TEMP: Temperature-adaptive FEGH — bridge count and gran" (impact=0.46) → braid go t-8e8cf412

</braid-methodology>

<braid-seed>
<!-- Generated by braid. Do not edit manually. Regenerate: braid seed --inject AGENTS.md -->
<!-- Updated: 1774532452 | Store: 107575 datoms, 10180 entities -->
...
Next actions:
  1. Harvest — 177 transactions since last harvest. Knowledge at risk of loss.
