...
<!-- Updated: 1773188826 | Store: 2802 datoms, 687 entities -->

### Store Context
Braid datom store | 2802 datoms, 687 entities
Last harvest: Harvest session for task: Session 012: C7 self-bootstrap, injection engine, unix wall_time (7 candidates)
  Prior: Harvest session for task: Stage 1 target: budget-aware output, guidance injection, bilateral loop, interac... (6 candidates)
  Prior: Harvest session for task: spec coverage audit and roadmap (3 candidates)
...
- :spec/inv-harvest-005 (5 attrs)
- :spec/adr-harvest-004 (5 attrs)
- :spec/adr-trilateral-005 (5 attrs)
- :spec/adr-harvest-006 (5 attrs)
- :spec/inv-harvest-007 (5 attrs)
- :spec/inv-harvest-001 (5 attrs)
- :spec/neg-harvest-001 (5 attrs)
- :spec/adr-harvest-001 (5 attrs)
- :spec/adr-interface-010 (5 attrs)
- :harvest/session-braid-user-15 (5 attrs)
- ... and 35 more entities

### Next Actions

Next actions:
  1. Connect — Divergence Φ=210.6 with 83 cycles. Structural remediation needed.
  ...
  3. Investigate — 7 observation(s) have staleness > 0.8. Review or re-observe.
