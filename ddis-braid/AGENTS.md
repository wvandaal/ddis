...
<!-- Updated: 1774499145 | Store: 104311 datoms -->

## Methodology Gaps
- 120 observations with uncrystallized spec IDs → braid spec create
- 27 tasks with unresolved spec refs → crystallize first
- 265 current-stage INVs untested → add L2+ witness
- concentration: 20 traces in FOUNDATION — Review: braid task search INV-FOUNDATION
...
1. "RDI-5: Precedent query — find_resolution_precedent(store, " (impact=1.10) → braid go t-d9536d87
2. "INQ-2: Discrepancy-driven steering — articulate expected v" (impact=0.65) → braid go t-3ff42cbd
3. "INQ-1-REV: Emergent concepts + auto-crystallization during o" (impact=0.64) → braid go t-786e3584

</braid-methodology>

<braid-seed>
<!-- Generated by braid. Do not edit manually. Regenerate: braid seed --inject AGENTS.md -->
<!-- Updated: 1774499145 | Store: 104311 datoms, 9995 entities -->
