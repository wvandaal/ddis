...
<!-- Updated: 1774358541 | Store: 75591 datoms -->

## Methodology Gaps
- 74 observations with uncrystallized spec IDs → braid spec create
- 15 tasks with unresolved spec refs → crystallize first
- 245 current-stage INVs untested → add L2+ witness
- concentration: 6 traces in FOUNDATION — Review: braid task search INV-FOUNDATION
- concentration: 8 traces in STORE — Review: braid task search INV-STORE
...
2. "FEGH-2: Surface bridge questions in compute_action_from_stor" (impact=0.29) → braid go t-06215eb2
3. "ATT-2-IMPL: Hebbian feedback from verbose-request detection." (impact=0.29) → braid go t-065fdbaa

</braid-methodology>

<braid-seed>
<!-- Generated by braid. Do not edit manually. Regenerate: braid seed --inject AGENTS.md -->
<!-- Updated: 1774358541 | Store: 75591 datoms, 7355 entities -->
