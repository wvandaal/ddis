...
<!-- Updated: 1773949319 | Store: 20636 datoms -->

## Methodology Gaps
- 30 observations with uncrystallized spec IDs → braid spec create
- 24 tasks with unresolved spec refs → crystallize first
...
1. "TOPO-SPEC-DEPS: Transact spec dependency edges — parse Tra" (impact=0.19) → braid go t-c2bbcda9
2. "MCP-EXTRACT-1: Behavioral signal taxonomy — define the 6 s" (impact=0.18) → braid go t-ff6a4143
3. "SUBSTRATE-1: Register abstract component schema — :compone" (impact=0.08) → braid go t-ae46a5c4
...
<braid-seed>
<!-- Generated by braid. Do not edit manually. Regenerate: braid seed --inject AGENTS.md -->
<!-- Updated: 1773949319 | Store: 20636 datoms, 2587 entities -->

### Session Context
Braid: append-only datom store (CRDT merge, content-addressed). 20636 datoms, 2587 entities. Codebase: 90500 LOC across 76 .rs files
Key files:
  ddis-braid/crates/braid-kernel/src/guidance.rs (7370 LOC)
  ...
  ddis-braid/crates/braid-kernel/src/schema.rs (3751 LOC)
Goal: harvest/seed replaces HARVEST.md. Status: 101 harvests, 259 observations, 123 decisions captured.
...
Tasks: 362 open (317 ready, 45 blocked) | Top: t-bcee P0 "EPIC: Stage 0 Merge Cascade (INV-MERGE-001..010)"
Last session: unsessioned harvest (17 txns since last harvest) (17 txns, 0 observations, +67 datoms, +1 entities)
  Changes: branch=main, 5 commits, 22 files (+415/-28)
Prior: unsessioned harvest (10 txns since last harvest) — ACP PROGRESS: 24 tasks closed this session. The three most critical commands
Prior: unsessioned harvest (34 txns since last harvest) — TASK GRAPH AUDIT — 7 issues found in ACP task graph:
...
### Recent Entities
- :spec/inv-topology-005 — Coupling-to-Topology Determinism
- :task/t-463e815d (17 attrs)
- :task/t-57c4333f (13 attrs)
- :task/t-dc54f525 (12 attrs)
- :task/t-21af64fc (13 attrs)
- :task/t-3f8df462 (14 attrs)
- :task/t-593e4434 (22 attrs)
- :task/t-eeaf0160 (12 attrs)
- :task/t-278ebb33 (11 attrs)
- :task/t-bccdf2b3 (17 attrs)
- :task/t-ffd1dd85 (14 attrs)
