...
(spec/02-schema.md line 144). The bootstrap path (guide/00-architecture.md line 666)
explicitly states "Cross-references (`:spec/traces-to`, `:spec/depends-on`) become ref datoms."

**Gap**: The worked example (guide/11-worked-examples.md, Step 3) transacts INV-STORE-001
...
**Task**: Extend guide/11-worked-examples.md Step 3 to show `:spec/depends-on`
...
**Task**: Update guide/00-architecture.md §0.3b Phase 2 to specify that the
